...
// <h3 classNam  onClick={() => setIsOpen(false)}e={`relative mt-2 text-3xl font-extrabold ${styles.text}`}>
//   {value || 0}
// </h3>
//     </div>
//   );
...
export default function StatCard({ title, value, accent }) {
  const accentMap = {
    green: { border: "border-emerald-400", glow: "from-emerald-200/40", text: "text-emerald-700" },
    blue: { border: "border-blue-400", glow: "from-blue-200/40", text: "text-blue-700" },
    yellow: { border: "border-amber-400", glow: "from-amber-200/40", text: "text-amber-700" },
    purple: { border: "border-purple-400", glow: "from-purple-200/40", text: "text-purple-700" },
  };
  ...
  return (
    ...
    >
      ...
      <p className="relative text-sm font-semibold text-gray-500">{title}</p>
