...
import { Search, Bell, ChevronDown, UserCircle, LogOut, Menu, MessageCircle , Sparkles} from "lucide-react";
export default function Topbar({ setSidebarOpen  , setChatOpen}) {
