...
//       {/* ── Header ── */}
//       <header
//         className="sticky top-0 z-20 flex items-center gap-4 px-6 py-3.5 bg-white border-b border-gray-100"
...
//         <h1 className="text-base font-bold text-gray-800">Create Job Vacancy</h1>
//       </header>
