...
//     // fetch(`http://localhost:5000/api/hr/${vacancyId}/candidates/${userId}/status`, {
//       method: "POST",
...
//       // Show success toast
//       setToast({ message: `Candidate ${status === "APPROVED" ? "approved and email sent" : "rejected"}`, type: 'success' });
